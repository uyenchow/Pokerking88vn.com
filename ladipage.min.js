...
LadiPageScriptV2.prototype.init = function() {
    this.const = {
        ...
        LANG: {
            ...
            FORM_SEND_DATA_ERROR: "ÄĂ£ xáº£y ra lá»—i, vui lĂ²ng thá»­ láº¡i!",
    ...
    this.isNull(window.ladi_is_desktop) ? this.runtime.isDesktop = t ? !/android|webos|iphone|ipad|ipod|blackberry|iemobile|opera mini/i.test(navigator.userAgent.toLowerCase()) : LadiPage.isDesktop() : this.runtime.isDesktop = t ? window.ladi_is_desktop : LadiPage.isDesktop(), this.runtime.device = this.runtime.isDesktop ? this.const.DESKTOP : this.const.MOBILE, this.runtime.tmp.isFirstScroll = !0, this.runtime.tmp.capture_form_data_last = {}, this.runtime.tmp.runAfterLocation = [], this.runtime.tmp.product_info = {}, this.runtime.tmp.timeout_product_info = {}, this.runtime.tmp.add_to_cart_detail = [], this.runtime.tmp.is_click_add_to_cart = !1, this.changeTotalPriceAddToCartDetail();
                                ...
                                if (!e.isEmpty(u)) {
                                    ...
                                    if (c["option.input_add_to_cart_variant_product_type"] != e.const.ADD_TO_CART_PRODUCT_TYPE.combined) {
                                        var g = (parseFloat(getComputedStyle(s).top) || 0) + (parseFloat(getComputedStyle(s).height) || 0),
                                            _ = "style_add_to_cart_" + i,
                                            f = "#" + s.id + " {height: auto;}";
                                        e.createStyleElement(_, f);
                                        var h = s.clientHeight - d,
                                            v = e.findAncestor(s, "ladi-element");
                                        if (!e.isEmpty(v)) {
                                            for (var E = v.getElementsByClassName("ladi-element"), L = (parseFloat(getComputedStyle(l).height) || 0) + h, S = 0; S < E.length; S++)
                                                if (E[S].id != s.id) {
                                                    var A = (parseFloat(getComputedStyle(E[S]).top) || 0) + (parseFloat(getComputedStyle(E[S]).height) || 0);
                                                    A > g ? (f += "#" + E[S].id + " {top: " + ((parseFloat(getComputedStyle(E[S]).top) || 0) + h) + "px;}", A + h > L && (L = A + h)) : A > L && (L = A)
                                                } var w = "#" + i + " {height: " + L + "px;}";
                                            e.createStyleElement(_, f + w)
                                        }
                                    }
                                }
                            }
                    ...
                    if (n && e.isEmpty(t)) i();
                        ...
                        if (!e.isEmpty(o)) {
                            ...
                            if (!e.isEmpty(l)) {
                                ...
                                if (!e.isEmpty(s)) {
                                    var c = s["option.form_account_id"],
                                        d = s["option.add_to_cart_product"];
                                    if (!e.isEmpty(c) && !e.isEmpty(d)) {
                                        var u = e.generateVariantProduct(d, !1, c, null, null, null, null, !0, !0, function(t) {
                                            a(!1)
                                        });
                                        if (e.isObject(u) && e.isObject(u.product)) {
                                            for (var p = e.getProductVariantIndex(l.id, d, c), m = document.querySelectorAll('[data-variant="true"]'), y = 0; y < m.length; y++)
                                                if (m[y].id != o.id) {
                                                    ...
                                                    if (!e.isEmpty(g)) {
                                                        ...
                                                        if (g["option.input_add_to_cart_variant_product_type"] == e.const.ADD_TO_CART_PRODUCT_TYPE.combobox) {
                                                            ...
                                                            for (var f = u.product.variants[p], h = f.option_ids.split("/"), v = 0; v < h.length; v++) _ = document.querySelector("#" + m[y].id + ' [data-product-variant-id="' + h[v] + '"]'), e.isEmpty(_) || (_.value = f["option" + (v + 1)])
                                                        }
                                                        if (g["option.input_add_to_cart_variant_product_type"] == e.const.ADD_TO_CART_PRODUCT_TYPE.combined) {
                                                            if (_ = m[y].querySelector("select.ladi-form-control"), e.isEmpty(_)) continue;
                                                            _.value = p + ""
                                                        }
                                                    }
        ...
        function() {
            var i = document.getElementsByClassName("ladi-form"),
                ...
                _ = function(t, i) {
                    ...
                    if (m.only(p).length == p.length)
                        for (var g = 0; g < m.length; g++) {
                            var _ = p.indexOf(m[g]); - 1 != _ && (m[g] = y[_])
                        }
                    for (var f = 0; f < m.length; f++) a[m[f]] = "";
                    n = Object.keys(a);
                    for (var h = 0; h < r.length; h++) {
                        if (c = r[h].getAttribute("name"), r[h].required && -1 == o.indexOf(c) && o.push(c), "INPUT" == r[h].tagName) {
                            var v = r[h].getAttribute("type").trim().toLowerCase(),
                                E = r[h].getAttribute("pattern"),
                                L = r[h].getAttribute("title");
                            if ("email" == v ? l.push({
                                    name: c,
                ...
                f = function(t, i, o) {
                    ...
                    t ? (l.status_send = 1, l.data_key = i) : l.status_send = 2, e.isEmpty(e.runtime.time_zone) || (l.time_zone = e.runtime.time_zone), n.forEach(function(t) {
                        var i = a[t];
                        e.isArray(i) && 0 == i.length && (i = ""), l.form_data.push({
                            name: t,
                            value: i
                        })
                        ...
                        var i = c[t];
                        i = e.isNull(i) ? "" : i, l.tracking_form.push({
                            name: t,
                            value: i
                        })
                    }), e.isFunction(o) && o(l)
                    ...
                    if (!e.isEmpty(y)) {
                        ...
                        if (e.isEmpty(E) || (r = E["option.form_config_id"]), u) {
                            ...
                            f(u, p, function(t) {
                                ...
                                !e.isEmpty(e.runtime.tmp.capture_form_data_last[p + "_" + m]) && e.equals(e.runtime.tmp.capture_form_data_last[p + "_" + m], a) || (e.runtime.tmp.capture_form_data_last[p + "_" + m] = a, e.sendRequest("POST", e.const.API_FORM_DATA, JSON.stringify(t), !0, {
                                    "Content-Type": "application/json"
                                }))
                            })
                        } else if (e.isEmpty(E)) v(y);
                            ...
                            var L = E["option.form_send_ladipage"],
                                S = E["option.form_api_data"],
                                A = E["option.thankyou_type"],
                                w = E["option.thankyou_value"],
                                P = E["option.is_add_to_cart"];
                            if (P || !e.isEmpty(r)) {
                                if (_(y, u), g(y, u, m))
                                    if (P) console.log("click MUA NGAY Add To Cart");
                                    else {
                                        var b = 0,
                                            C = 0,
                                            T = [],
                                            ...
                                            I = function() {
                                                ...
                                                n = function() {
                                                    ...
                                                    A == e.const.FORM_THANKYOU_TYPE.default && (w = e.isEmpty(w) ? e.const.LANG.FORM_THANKYOU_MESSAGE_DEFAULT : w, e.showMessage(w, a)), A == e.const.FORM_THANKYOU_TYPE.popup && (o && e.setDataReplaceElement(!1, !1, a, w), window.ladi(w).show()), A == e.const.FORM_THANKYOU_TYPE.url && window.ladi(w).open_url("_top", o ? a : null)
                                            ...
                                            k = function(t, a, n, r) {
                                                if (n.readyState == XMLHttpRequest.DONE) {
                                                    ...
                                                    b + C == T.length && (D && !N && b >= 1 ? (N = !0, e.runEventTracking(i.id, !0), I(), O(!0)) : !x && C >= 1 && (x = !0, e.showMessage(e.const.LANG.FORM_SEND_DATA_ERROR), O(!1)))
                                                }
                                            },
                                            R = function(t) {
                                                T.push({
                                        ...
                                        L && f(u, p, R), e.isArray(S) && S.forEach(function(t) {
                                        ...
                                        T.length > 0 ? B() : L ? v(y) : (B(), f(u, p, R)), T.forEach(function(t) {
                    ...
                    if (!e.isEmpty(i)) {
                        for (var a = i.querySelectorAll('[ladi-checkbox-required="true"]'), n = -1, r = 0; r < a.length; r++)
                            ...
                            if (o.length > 0) {
                                ...
                                for (var l = 0; l < o.length; l++) o[l].removeEventListener("change", L), o[l].addEventListener("change", L);
                            ...
                            if (!e.isEmpty(n) && n["option.is_add_to_cart"] && !e.isEmpty(n["option.add_to_cart_product"]) && !e.isEmpty(n["option.form_account_id"])) {
                                var r = function() {
                                    ...
                                    if (!(e.isEmpty(t) || e.isEmpty(t.store_info) || e.isEmpty(t.product))) {
                                        ...
                                        if (-1 != i) {
                                            var o = t.product.variants[i].product_variant_id,
                                                l = t.product.name,
                                                s = t.product.variants[i].title,
                                                c = t.product.variants[i].price,
                                                d = t.product.variants[i].quantity,
                                                u = e.isEmpty(t.product.variants[i].thumb) ? "" : t.product.variants[i].thumb;
                                            u = e.isEmpty(u) && !e.isEmpty(t.product.variants[i].src) ? t.product.variants[i].src : u, u = e.isEmpty(u) && !e.isObject(t.product.image) ? t.product.image.src : u, e.isEmpty(u) || (u = "https://" + e.const.STATIC_DOMAIN + "/" + u);
                                            var p = e.runtime.tmp.add_to_cart_detail.findIndex(function(t) {
                                                return t.product_variant_id == o
                                            }); - 1 == p && (e.runtime.tmp.add_to_cart_detail.push({
                                            ...
                                            }), p = e.runtime.tmp.add_to_cart_detail.length - 1);
                                            var m = a.querySelector('input[name="quantity"]');
                                            if (!e.isEmpty(m) && !e.isEmpty(m.value)) {
                                                var y = parseInt(m.value) || 0;
                                                if (1 == t.product.variants[i].inventory_checked && e.runtime.tmp.add_to_cart_detail[p].quantity + y > d && (y = d - e.runtime.tmp.add_to_cart_detail[p].quantity), y > 0) {
                                                    var g = function() {
                                                        e.runtime.tmp.add_to_cart_detail[p].quantity += y, e.addAddToCartDetailCookie(t.store_info.id, {
                                                            product_variant_id: o,
                                                            quantity: y,
                                                            ladipage_id: e.runtime.ladipage_id
                                                        }, null, function() {
                                                            e.runtime.tmp.add_to_cart_detail[p].quantity -= y
                                                        }, function() {
                                                        ...
                                                        if (e.runtime.tmp.is_click_add_to_cart) {
                                                            var _ = function() {
                                                                e.runTimeout(function() {
                                                                    if (e.runtime.tmp.is_click_add_to_cart) return _();
                                                                    r()
                                                                }, 100)
                                                            };
                                                            _()
                                                        } else e.runtime.tmp.is_click_add_to_cart = !0, g();
                                                    else g()
                                                }
                                            }
                                        }
            ...
            var C = 0,
                ...
                N = !1,
                x = function(t) {
                    for (var a = i[C].querySelectorAll('.ladi-element .ladi-form-item-container [name="' + t + '"]'), n = 0; n < a.length; n++)
                        if (!e.isEmpty(b[t]))
                            if ("SELECT" == a[n].tagName) a[n].querySelectorAll('option[value="' + b[t] + '"]').length > 0 && (a[n].value = b[t], T && a[n].dispatchEvent(new Event("change")));
                            else {
                                if (N) {
                                    var r = b[t].split(":");
            ...
            for (C = 0; C < i.length; C++) {
                i[C].onsubmit = S;
                for (var D = i[C].getElementsByClassName("ladi-button"), O = 0; O < D.length; O++) {
                    var I = i[C].getElementsByClassName("ladi-button")[O];
                    if (!e.isEmpty(I)) {
                        var k = e.findAncestor(I, "ladi-element");
                        !e.isEmpty(e.runtime.eventData[k.id]) && e.runtime.eventData[k.id]["option.is_add_to_cart"] ? k.addEventListener("click", A) : k.addEventListener("click", w)
                    }
                }
                for (var R = i[C].querySelectorAll("[tabindex]"), B = 0, M = 0; M < R.length; M++) {
                    var V = parseInt(R[M].getAttribute("tabindex")) || 0;
                    V > B && (B = V), R[M].setAttribute("tabindex", e.runtime.tabindexForm + V)
                }
                e.runtime.tabindexForm += B;
                for (var F = 0; F < m.length; F++) {
                    var q = i[C].querySelector('.ladi-element .ladi-form-item-container input[name="' + m[F] + '"]');
                    e.isEmpty(q) || q.addEventListener("focusout", P)
                }
            }
            ...
            e.runtime.tmp.runAfterLocation.push(function() {
                ...
                for (C = 0; C < i.length; C++) {
                    var c = i[C].querySelectorAll('.ladi-element .ladi-form-item-container [name="state"]'),
                        d = 0,
                        u = null;
            ...
            for (var t = 2500, i = 3800, a = 800, n = 50, r = 150, o = 500, l = 1300, s = 600, c = 1500, d = t, u = function(i, a, n, r) {
                    ...
                    if (!e.isEmpty(c)) {
                        ...
                        if (e.isEmpty(e.findAncestor(c, "type")))
                            if (e.isEmpty(e.findAncestor(c, "letters"))) e.isEmpty(e.findAncestor(c, "clip")) ? e.isEmpty(e.findAncestor(c, "loading-bar")) ? (y(c, d), e.runTimeout(function() {
                                _(d)
    ...
    if (!this.isEmpty(a)) {
        ...
        if (this.isEmpty(n)) {
            var r = this.getVideoId(e, i),
                o = a.getElementsByClassName("ladi-video")[0];
    ...
    this.sendRequest("POST", LadiPageScript.const.API_LADISALE_ADD, JSON.stringify(e), !0, o, function(t, e, r) {
        if (r.readyState == XMLHttpRequest.DONE) {
            if (200 == e) try {
                var o = JSON.parse(t);
                if (200 == o.code) return l.setCookie(null, "_cart_token", o.data.cart_token, 30, !1, window.location.pathname), l.isFunction(i) && i(), void(l.isFunction(n) && n())
            } catch (t) {}
    ...
    this.sendRequest("POST", LadiPageScript.const.API_LADISALE_UPDATE, JSON.stringify(t), !0, r, function(t, n, r) {
        if (r.readyState == XMLHttpRequest.DONE) {
            if (200 == n) try {
                if (200 == JSON.parse(t).code) return o.isFunction(e) && e(), void(o.isFunction(a) && a())
            } catch (t) {}
            o.isFunction(i) && i(), o.isFunction(a) && a()
        }
    })
}, LadiPageScriptV2.prototype.createAddToCartDetailData = function() {
    this.runtime.tmp.add_to_cart_detail = [];
    var t = this,
        e = function() {
    ...
    var i = this.formatNumber(t, 3);
    this.runtime.tmp.add_to_cart_detail.length > 0 && !this.isEmpty(this.runtime.tmp.add_to_cart_detail[0].currency) && !this.isEmpty(this.runtime.tmp.add_to_cart_detail[0].currency.symbol) && (i += " " + this.runtime.tmp.add_to_cart_detail[0].currency.symbol), this.setDataReplaceStr("cart_total_price", i), this.setDataReplaceStr("cart_total_payment_price", i), this.setDataReplaceStr("cart_total_quantity", e), this.setDataReplaceElement(!1)
    ...
    var e = this.runtime.tmp.add_to_cart_detail.findIndex(function(e) {
        ...
        i = this; - 1 != e && this.updateAddToCartDetailCookie({
        product_variant_id: t,
        quantity: 0
    }, function() {
        i.runtime.tmp.add_to_cart_detail.splice(e, 1), i.runtime.tmp.generateAddToCartDetail(), i.changeTotalPriceAddToCartDetail(), 0 == i.runtime.tmp.add_to_cart_detail.length && i.deleteCookie("_cart_token")
    })
    ...
    if (-1 != a) {
        ...
        if (this.isEmpty(t.value)) i && (t.value = 1), this.runtime.tmp.add_to_cart_detail[a].quantity = 1;
        else {
        ...
        this.updateAddToCartDetailCookie({
            ...
            var t = n.formatNumber(n.runtime.tmp.add_to_cart_detail[a].price * n.runtime.tmp.add_to_cart_detail[a].quantity, 3);
            n.isObject(n.runtime.tmp.add_to_cart_detail[a].currency) && !n.isEmpty(n.runtime.tmp.add_to_cart_detail[a].currency.symbol) && (t += " " + n.runtime.tmp.add_to_cart_detail[a].currency.symbol);
            for (var i = document.querySelectorAll('[data-product-variant-id="' + e + '"]'), r = 0; r < i.length; r++) i[r].innerHTML = t
        })
    }
    ...
    return r += "<tbody>", 0 == n.length ? r += '<tr><td class="add-to-cart-detail-no-product">' + e + "</td></tr>" : n.forEach(function(e) {
        r += '<tr class="add-to-cart-detail-row"><td class="add-to-cart-detail-image"><img src="' + e.image + '" />', t == a.const.ADD_TO_CART_DETAIL_LAYOUT.viewonly && (r += '<span class="add-to-cart-detail-image-quantity">' + e.quantity + "</span>"), r += "</td>", r += '<td class="add-to-cart-detail-title"><span class="add-to-cart-detail-title-name">' + e.name + '</span><span class="add-to-cart-detail-title-variant">' + e.title + "</span></td>", t == a.const.ADD_TO_CART_DETAIL_LAYOUT.editable && (r += '<td class="add-to-cart-detail-quantity"><input' + (i ? "" : " disabled") + ' type="number" min="1" value="' + e.quantity + '" onchange="javascript: LadiPageScript.changeAddToCartProductQuantity(this, ' + e.product_variant_id + ', true);" /></td>'), r += '<td class="add-to-cart-detail-price"><span data-product-variant-id="' + e.product_variant_id + '">' + a.formatNumber(e.price * e.quantity, 3), a.isObject(e.currency) && !a.isEmpty(e.currency.symbol) && (r += " " + e.currency.symbol), r += "</span></td>", t == a.const.ADD_TO_CART_DETAIL_LAYOUT.editable && (r += '<td class="add-to-cart-detail-action"><button onclick="javascript: LadiPageScript.removeAddToCartProduct(' + e.product_variant_id + ');" type="button">' + a.const.LANG.REMOVE_BUTTON_TEXT + "</button></td>", r += "</tr>")
    }), r += "</tbody>"
    ...
    if (!u.isEmpty(t) && !u.isEmpty(i)) {
        ...
        if (u.isNull(p)) {
            ...
            return u.sendRequest("POST", u.const.API_SHOW_PRODUCT, JSON.stringify(y), !0, {
                "Content-Type": "application/json"
            }, function(e, a, n) {
                ...
                if (!this.isNull(g)) {
                    ...
                    if ("TEXTAREA" == p[m].tagName && (p[m].value = _.trim(), e && (p[m].innerHTML = p[m].value)), "SELECT" == p[m].tagName) {
                        ...
                        if (!this.isEmpty(S) && (p[m].value = S.getAttribute("value"), e && !S.hasAttribute("selected"))) {
                            for (var A = p[m].querySelectorAll("option"), w = 0; w < A.length; w++) A[w].removeAttribute("selected");
...
LadiPageScript.const.API_CHECK_VERIFY = "https://la.ladipage.com/2.0/domain/check", LadiPageScript.const.API_CHECKING_FORM = "https://la.ladipage.com/2.0/elastic/tracking-form", LadiPageScript.const.API_SHOW_PRODUCT = "https://api.ladipage.com/2.0/product/detail", LadiPageScript.const.API_LADISALE_ADD = "https://api.ladisales.com/2.0/cart/add", LadiPageScript.const.API_LADISALE_UPDATE = "https://api.ladisales.com/2.0/cart/update", LadiPageScript.const.API_LADISALE_SHOW = "https://api.ladisales.com/2.0/cart/show", LadiPageScript.const.API_FORM_DATA = "https://api.forms.ladipage.com/2.0/send-form", LadiPageScript.const.CDN_LIBRARY_JS_URL = "https://w.ladicdn.com/v2/source/", LadiPageScript.const.CDN_LIBRARY_CSS_URL = "https://w.ladicdn.com/v2/source/", (LadiPageAppV2 = LadiPageAppV2 || function() {}).prototype.notify_runtime = function(t, e) {
    var i = function() {},
        a = null,
        n = "top_left",
        r = "top_center",
